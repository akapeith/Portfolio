export const Home = () =>{
    return <section id = "home" className="min-h-screen flex items-center justify-center relative">
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 
            bg-clip-text text-transparent leading-right">
                Hi, I am Khodor Wahab.
            </h1>
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                 I'm a full-stack developer passionate about creating clean, responsive, and user-friendly applications for both web and mobile. I love bringing ideas to life through thoughtful design and smooth functionality, always aiming to deliver great digital experiences.
            </p>
